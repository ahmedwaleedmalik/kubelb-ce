...
type Connection struct {
	...
	TargetPort string
	Token      string
	Stream     grpc.BidiStreamingServer[pb.TunnelMessage, pb.TunnelMessage]
...
func (tr *Registry) RegisterTunnel(hostname string, stream grpc.BidiStreamingServer[pb.TunnelMessage, pb.TunnelMessage], token, targetPort string) error {
	tr.mutex.Lock()
