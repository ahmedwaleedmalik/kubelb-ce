...
| kubelb.tunnel.connectionManager.httpRoute | object | `{"annotations":{"cert-manager.io/cluster-issuer":"letsencrypt-prod","external-dns.alpha.kubernetes.io/hostname":"connection-manager.${DOMAIN}"},"domain":"connection-manager.${DOMAIN}","enabled":false,"gatewayName":"gateway","gatewayNamespace":""}` | HTTPRoute configuration for external gRPC access (Gateway API) |
